    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-lg-3 p-b-50">
          ...
          <p class=" cl7 size-201">
            Bạn cần liên hệ?<br /> Studio Như tại Phường 2 - Thành phố Cà Mau - Việt Nam <br />hoặc gọi số (+84) 0908 303 032
          </p>
      ...
      <div class="p-t-40">
        <p class="stext-107 cl6 txt-center">
          ...
          </script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Phạm Văn Á</a>
